...
func TestPersistenceWorkflow(t *testing.T) {
	...
	sas, err := client.GetWorkflowSearchAttributes(context.Background(), &persistenceWorkflow{}, wfId, "", []string{
		...
		// testSearchAttributeDatetime, // TODO https://github.com/mitchjtn/iwf/issues/261
	...
	expectedSas := map[string]interface{}{
		...
		// testSearchAttributeDatetime: sas[testSearchAttributeDatetime], // // TODO https://github.com/mitchjtn/iwf/issues/261
